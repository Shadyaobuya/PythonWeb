...
from .views import edit_student, register_student, search_student,student_list,student_home,student_courses,home, view_profile,delete_student
app_name='student'
urlpatterns =[
    path('register/',register_student,name='register_student'),
    path('student-home/',home,name='student-home'),
    path('list/',student_list,name='student-list'),
    path('home/',student_home,name='home'),
